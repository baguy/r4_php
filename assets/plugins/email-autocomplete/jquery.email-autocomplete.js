...
(function ($, window, document, undefined) {
  ...
  function EmailAutocomplete(elem, options) {
    this.$field = $(elem);
    this.$container = $(elem).parent('.input-group');
  ...
  EmailAutocomplete.prototype = {
    init: function () {
      ...
      var $wrap = $("<div class='eac-input-wrap' />").css({
        ...
        zIndex: 1999,
        left: (((this.$field.outerWidth(true) - this.$field.width()) / 2) - 13.2188) + "px" //'40.2188px'
      });
      ...
      this.$suggOverlay = $("<span class='"+this.options.suggClass+"' />").css({
        ...
        paddingTop: (heightPad + 0) + "px",
        paddingBottom: (heightPad - 2) + "px",
        fontFamily: this.$field.css("fontFamily"),
        fontWeight: this.$field.css("fontWeight"),
        letterSpacing: this.$field.css("letterSpacing"),
        position: "absolute",
      ...
      this.$container.children('.eac-input-wrap').append(this.$suggOverlay);
