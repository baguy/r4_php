<?php
	...
	class PendenteBuilder {

		private $instance;

		public function __construct() {

			$this->instance = new Pendente();
		}
		...
		public function getBasicRestrictions($parameters = array()) {
			...
			if(Auth::user()->hasRole('ADMIN') || Auth::user()->hasRole('LAB')){
				$this->instance = $this->instance->where('tipo_status_id', '=', 1);
			}else{
				$this->instance = $this->instance->where('tipo_status_id', '=', 1)->whereHas('solicitacao', function ($q) use($parameters) {
