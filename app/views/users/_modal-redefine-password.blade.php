<div id="modalRedefinePassword_{{ $user->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($user, array('method' => 'GET', 'route' => array('users.redefine-password', $user->id))) }}
