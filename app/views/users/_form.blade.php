  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        {{ Form::label('unidades', trans('users.lbl.unidade')) }}<span class="obrigatorio">*</span>
      ...
      <div class='row'>
        ...
        <div class="form-group col-4 {{ ($errors->has('matricula')) ? 'has-error' : '' }}">

          <div class="input-group">
          {{ Form::label('matricula', trans('users.lbl.matricula')) }}<span class="obrigatorio">*</span>


            {{
              Form::text(
                'matricula',
                isset($user->matricula)?$user->matricula:null,
                array(
                  'class'            => ($errors->has('matricula')) ? 'form-control has-error__icon' : 'form-control ml-3',
                  'placeholder'      => trans('users.plh.matricula'),
                  'aria-describedby' => 'matriculaAddon'
                )
              )
            }}
        ...
        <div class="form-group col-4 {{ ($errors->has('registro')) ? 'has-error' : '' }}">

          <div class="input-group">
          {{ Form::label('registro', trans('users.lbl.registro')) }}


            {{
              Form::text(
                'registro',
                isset($user->registro)?$user->registro:null,
                array(
                  'class'            => ($errors->has('registro')) ? 'form-control has-error__icon' : 'form-control ml-3',
                  'placeholder'      => trans('users.plh.registro'),
                  'aria-describedby' => 'registroAddon'
                )
              )
            }}

            <div class="input-group-append">
              <span id="registroAddon" class="input-group-text rounded-right">
        ...
        <div class="form-group col-4 {{ ($errors->has('responsavel')) ? 'has-error' : '' }}">

          {{ Form::label('responsavel', trans('users.lbl.responsavel'))}}
