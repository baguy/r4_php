        ...
        @foreach ($elements as $produto)
          ...
          <tr class="{{ ($isTrashed) ? 'table-danger' : '' }}">
            ...
            @if (!$C_group)
              ...
              @include('templates/parts/datatable/_datatable__collapse--one', [
                'collapse_id' => "collapseUnidade_$produto->id"
              ])

              <td class="align-middle w-auto">
                <span class="ellipsis">{{ $produto->nome }}</span>
              </td>
            ...
            @if ($C_group)
              ...
              @include('templates/parts/datatable/_datatable__total--td', [ 'model' => $produto ])
            ...
            @if (!$C_group)
              ...
              <td class="align-middle col-options-3">
                ...
                @include('templates/parts/datatable/_datatable__options--buttons', [
                  ...
                  'route_show'      => route('produtos.show', [ $produto->id ]),
                  'is_printable'    => false
                ])
          ...
          <tr>
            ...
            <td class="description">
              ...
              <div class="collapse" id="collapseUnidade_{{ $produto->id }}">
