<div id="modalDeleteExame_{{ $exame->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        {{ Form::model($exame->laudo, array('method' => 'DELETE', 'route' => array('exames.destroy', $exame->id))) }}
