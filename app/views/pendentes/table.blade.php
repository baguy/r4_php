@if ($elements->count())
  ...
  <?php
    $e_data_inicio = 0; $e_data_fim = 0; $e_exame = 0; $e_solicitacao = 0;
          ...
          @if (!$C_group)
            ...
            <th class="col-options-3">
              ...
              @include('templates/parts/datatable/_datatable__options--list', array(
                ...
                'show_print'   => false,
                'show_export'  => false,
                'show_export_vdrl'      => true,
                'route_export_vdrl'     => route('pendentes.export_vdrl', [ $e_data_inicio,$e_data_fim ]),
                'show_export_hiv'       => true,
                'route_export_hiv'      => route('pendentes.export_hiv', [ $e_exame,$e_solicitacao,$e_data_inicio,$e_data_fim,$pre='hiv' ]),
                'show_export_toxo'      => true,
                'route_export_toxo'     => route('pendentes.export_toxo', [ $e_exame,$e_solicitacao,$e_data_inicio,$e_data_fim,$pre='toxo' ]),
                'show_export_protocolo' => true,
                'route_export_protocolo'=> route('pendentes.export_protocolo', [ $e_exame,$e_solicitacao,$e_data_inicio,$e_data_fim,$pre='geral' ]),
                'is_groupable' => true,
                'groupables'   => [
                  [
                    'group' => 'status',
