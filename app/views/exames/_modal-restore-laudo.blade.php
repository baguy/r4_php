<div id="modalRestoreLaudo_{{ $produto->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($produto, array('method' => 'PATCH', 'route' => array('produtos.restore', $produto->id))) }}
