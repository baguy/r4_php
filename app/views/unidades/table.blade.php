        ...
        @foreach ($elements as $unidade)
          ...
          <tr class="{{ ($isTrashed) ? 'table-danger' : '' }}">
            ...
            @if (!$C_group)
              ...
              @include('templates/parts/datatable/_datatable__collapse--one', [
                'collapse_id' => "collapseUnidade_$unidade->id"
              ])

              <td class="align-middle w-auto">
                <span class="ellipsis">{{ $unidade->nome }}</span>
              </td>
            ...
            @if ($C_group)
              ...
              @include('templates/parts/datatable/_datatable__total--td', [ 'model' => $unidade ])
            ...
            @if (!$C_group)
              ...
              <td class="align-middle col-options-3">
                ...
                @include('templates/parts/datatable/_datatable__options--buttons', [
                  ...
                  'route_show'      => route('unidades.show', [ $unidade->id ]),
                  'is_printable'    => false
                ])
          ...
          <tr>
            ...
            <td class="description">
              ...
              <div class="collapse" id="collapseUnidade_{{ $unidade->id }}">
